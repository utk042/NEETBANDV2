...
export default function LMSLogin({ onLoginSuccess, navigate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFeedbackMsg({ type: 'success', text: `Welcome back, Admin ${data.name}!` });
        ...
        <div className="bg-surface-container-lowest rounded-3xl border border-[var(--border-floating-card)] p-8 md:p-10 shadow-[var(--shadow-floating-card)] relative overflow-hidden">
          ...
          <div className="mb-6">
            ...
            <p className="font-body-md text-sm text-on-surface-variant">
              Log in with your administrator credentials to manage courses and songs.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <label htmlFor="lms-email" className="font-label-md text-sm font-semibold text-on-surface-variant">
                Admin Email
              </label>
              <input 
                type="email" 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="lms-password" className="font-label-md text-sm font-semibold text-on-surface-variant">
                Password
              </label>
