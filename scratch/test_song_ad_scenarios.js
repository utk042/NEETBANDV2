...
import songRoutes from '../backend/src/routes/songRoutes.js';
import adConfigRoutes from '../backend/src/routes/adConfigRoutes.js';
import { getAds } from '../backend/src/controllers/songController.js';
import Song from '../backend/src/models/Song.js';
import AdConfig from '../backend/src/models/AdConfig.js';
...
async function runTestSuite() {
  ...
  const songsPassed = songsRes.status === 200 && Array.isArray(songsRes.body);
  ...
  // Scenario 1: Guest User - Chapter 1 Song 1 at start (0% progress)
  ...
  // Scenario 5: Free User plays Study Song with >3-4 Pre-roll Ads
